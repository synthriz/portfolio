export function getProjetos(language: "pt" | "en") {
  return [
    ...
    },
    {
      ...
      tecnologias: ["Astro", "TinaCMS", "tailwind css", "javascript"],
      githubLink: "https://github.com/synthriz/astro-landing-page-generator",
      deployLink: "https://astro-generator.surge.sh/",
    },
    {
      imagem: "static/cvgenerator.png",
      nome: language === "pt" ? "Gerador de CV" : "CV Generator",
      descricao:
        language === "pt"
          ? "Aplicação web para criar e editar currículos com múltiplos templates e exportação em PDF. ATS-Friendly."
          : "Web application to create and edit resumes with multiple templates and PDF export. ATS-Friendly.",
